...
# from a_star import A_star as Planner
...
class GlobalPlanner:
    def __init__(self):
        # self.planner = None     # RRT
        # self.map = None         # OccupancyGrid
        # self.plan_goal = None   # PoseStamped
        self.plan_sx = 0.0  # start
        self.plan_sy = 0.0
        self.plan_gx = 8.0  # goal
        self.plan_gy = -8.0
        self.plan_grid_size = 0.3
        self.plan_robot_radius = 0.8
        self.plan_ox = []       # obstacles
        self.plan_oy = []
        self.plan_rx = []       # trajectory
        self.plan_ry = []
    ...
    def replan(self, req):
        ...
        self.initPlanner()
        self.updateGlobalPose()
        rospy.loginfo("start: (%.2f, %.2f)", self.plan_sx, self.plan_sy)
        rospy.loginfo("goal: (%.2f, %.2f)", self.plan_gx, self.plan_gy)
    ...
    def initPlanner(self):
        ...
        # plt.scatter(self.plan_ox, self.plan_oy)
        # plt.show()
